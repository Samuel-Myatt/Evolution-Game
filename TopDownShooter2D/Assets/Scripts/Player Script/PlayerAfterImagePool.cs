...
public class PlayerAfterImagePool : MonoBehaviour
{
    ...
    private void GrowPool()
    {
        for(int i = 0; i < 10; i++)
        {
            ...
            instanceToAdd.transform.SetParent(transform);//Makes the game object we created a child of the game object this script is attached to.
    ...
    public GameObject GetFromPool()
    {
        ...
        instance.SetActive(true);//Causes OnEnable function in PlayerAfterImageSprite to be called.
        return instance;
    }
}
